...
INSERT INTO sec_user (id, created_by, created_date, activated, login, password_hash, first_name, last_name, email, lang_key)
VALUES
  (1, 'system', now(), true, 'admin', '$2a$10$gSAhZrxMllrbgj/kkK9UceBPpChGWJA7SYIb1Mqo.n5aNLq1/oRrC', 'Administrator', 'Administrator', 'admin@localhost', 'vi'),
  (2, 'system', now(), true, 'user',  '$2a$10$VEjxo0jq2YG9Rbk2HmX9S.k1uZBGYUHdUcid3g/vfiEl7lwWgOH/K', 'User', 'User', 'user@localhost', 'vi')
