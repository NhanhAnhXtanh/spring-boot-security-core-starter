package com.vn.security.core.service.mapper.security;
...
import com.vn.security.core.service.mapper.EntityMapper;
...
public interface SecPermissionMapper extends EntityMapper<SecPermissionDTO, SecPermission> {
    ...
    @Mapping(
        target = "targetType",
        expression = "java(dto.getTargetType() != null ? com.vn.security.core.security.permission.TargetType.valueOf(dto.getTargetType()) : null)"
    )
