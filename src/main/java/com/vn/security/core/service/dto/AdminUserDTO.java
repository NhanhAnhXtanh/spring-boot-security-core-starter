...
public class AdminUserDTO implements Serializable {
    ...
    /**
     * Optional password supplied by an admin when creating a user.
     * Write-only — never serialized in responses. When null/blank a random password is generated.
     */
    ...
    public AdminUserDTO(User<Long> user) {
        this.id = user.getId();
