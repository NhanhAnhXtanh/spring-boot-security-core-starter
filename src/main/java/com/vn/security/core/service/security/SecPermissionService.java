...
public class SecPermissionService {
    ...
    public Optional<SecPermission> findById(Long id) {
        return secPermissionStore.findById(id);
    }
    ...
    public List<SecPermission> findDuplicates(String authorityName, TargetType targetType, String target, String action) {
        return secPermissionStore.findAllByAuthorityNameAndTargetTypeAndTargetAndActionOrderByIdAsc(
            authorityName,
            targetType,
            target,
            action
    ...
    public List<SecPermission> findByAuthorityName(String authorityName) {
        return secPermissionStore.findByAuthorityName(authorityName);
    }
