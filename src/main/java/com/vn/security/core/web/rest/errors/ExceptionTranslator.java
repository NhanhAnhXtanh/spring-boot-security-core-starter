...
import com.vn.security.core.config.AppConstants;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        ...
        return ProblemDetailWithCause.instance().withStatus(toStatus(ex).value()).build();
    }
    ...
    protected ProblemDetailWithCause customizeProblem(ProblemDetailWithCause problem, Throwable err, NativeWebRequest request) {
        ...
        if (problemProperties == null || !problemProperties.containsKey(MESSAGE_KEY)) {
            problem.setProperty(MESSAGE_KEY, getMappedMessageKey(err) != null ? getMappedMessageKey(err) : "error.http." + problem.getStatus());
        }
    ...
    private boolean containsPackageName(String message) {
        return Strings.CS.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.vn.security.core");
    }
}
